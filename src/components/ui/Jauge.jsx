  ...
  return (
    <div className="my-2">
      <div className="flex justify-between text-sm mb-3">
        <div>
          <p className="text-gray-500 text-xs mb-0.5">{label1}</p>
          <p className={`text-xl font-bold tabular-nums ${avantage ? 'text-success' : 'text-navy'}`}>
            {montant1.toLocaleString('fr-FR')} €
          </p>
        </div>
        <div className="text-right">
          <p className="text-gray-500 text-xs mb-0.5">{label2}</p>
